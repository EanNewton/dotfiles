...
;
; #+e 
; -- Open file as new template in Word
; -- [Windows + Shift + e]
; +F1
; -- [Shift + F1]
; -- Key binding for calling PutXResources()
; ^+SPACE
; -- [Control + Shift + Space]
; -- Toggle the active window as always on top
; PutXResources()
; -- Put script to recolor xterm (urxvt) into clipboard
;------------------------------------------------------------------------------
; 
; NEW TEMPLATE
;
...
;   English Double & Triple Contractions
;   User Defined (Win + H)
;------------------------------------------------------------------------------
...
; ::shoudln::should, shouldn't ; Overridden below
::sieze::seize, size
::siezed::seized, sized
...
;------------------------------------------------------------------------------
; Ean Custom Definitions
;------------------------------------------------------------------------------
; EN - Unicode Special Symbols
;------------------------------------------------------------------------------
::(c)::©
::(r)::®
::(tm)::™
...
:?:degrees::°
;------------------------------------------------------------------------------
; EN - Common English Abbreviations
;------------------------------------------------------------------------------
::abbrev::abbreviation
::abl::ablative
...
::cf::compared to
::cp::compare
; ::def::definition ; Commented out because of usage in code
; ::diff::difference ; Commented out because of usage in linux
::ea::each
; ::fr::from ; Commented out because of usage in www.site.fr
::impt::important
::nec::necessary
::pt::point
::pp::pages
::UFW::UWF
;------------------------------------------------------------------------------
; EN - Common English Contractions
;------------------------------------------------------------------------------
::arent::are not
::aren't::are not
::cant::cannot
...
::hed::he would
::he'd::he would
; ::hell:he will ; Breaks the common word "hell"
::he'll::he will
::hes::he is
::he's::he is
; ::Id::I would ; Breaks the common word "id"
::I'd::I would
::Idnt::I would not
::I'dnt::I would not
::I'dn't::I would  not
; ::ill::I will ; Breaks the common word "ill"
::I'll::I will
::Im::I am
::I'm::I am
::I'mma::I am going to
...
::musnt::must not
::musn't::must not
; ::shed::she would ; Breaks the common word "shed"
::she'd::she would
; ::shell::she will ; Breaks the common word "shell"
::she'll::she will
::shes::she is
::she's::she is
::shouldnt::should not
...
::theyve::they have
::they've::they have
; ::wed::we would ; Breaks the common word "wed" 
::we'd::we would
; ::were::we are ; Breaks the common word "were"
::we're::we are
::weve::we have
::we've::we have
::werent::were not
...
::wholl::who will
::who'll::who will
; ::whore::who are ; Breaks the common word "whore"
::whos::who is
::who's::who is
::whove::who have
::who've::who have
; ::wont::will not ; Breaks the common word "wont"
::won't::will not
::wouldnt::would not
::wouldn't::would not
; ::yall::you all ; Disabled by preference
; ::y'all::you all ; Disable by preference
::yall::y'all  ; Enabled by preference
::youd::you would
::you'd::you would
::youll::you will
::you'll::you will
...
::you've::you have
;------------------------------------------------------------------------------
; EN - English Double & Triple Contractions
;------------------------------------------------------------------------------
::cantve::can not have
::can't've::can not have
::couldntve::could not have
::couldn't've::could not have
::dyall::do y'all ; Enabled by preference
::d'y'all::do y'all ; Enabled by preference
::fo'c's'le::forecastle
::fo'c'sle::forecastle
::foc's'le::forecastle
::fo'c's'les::forecastle
::hadntve::had not have
::hadn't've::had not have
::hadn'thave::had not have
::hadn't of::had not have
::hedve::he would have
...
::I'dntve::I would not have
::Idn'tve::I would not have
::I'dn'tve::I would not have
::Idnt've::I would not have
::I'dnt've::I would not have
::Idn't've::I would not have
...
::yaint::y'all are not
::y'ain't::y'all are not
::y'aint::y'all are not
::yalld::y'all would have
::y'all'd::y'all would have
::yalldve::y'all would have ; Enabled by preference
::y'all'd've::y'all would have ; Enabled by preference
::y'all'll::y'all will
::yall'll::y'all will
::yallll::y'all will
::yallre::y'all are
...
::yallve::y'all have
::y'alllve::y'all have
::youdnt::you would not
::you'dn't::you would not
::youdn't::you would not
::you'dnt::you would not
::youdntve::you would not have
::you'dntve::you would not have
::you'dn'tve::you would not have
::you'dnt've::you would not have
::youdn't've::you would not have
...
;============================== ini Section ==============================
; Only modify if you are storing values to this file that need to be
; permanantly saved. 
