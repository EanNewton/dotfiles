...
$destinationpath = $dest + '\WindowsEventLogs\'

# Checks the last character of the destination path.  If it does not end in '\' it adds one.
# '.+?\\$' +? means any character \\ is looking for the backslash $ is the end of the line character
...
write-host "The Script took $TotalTime seconds to execute. Dest is $destinationpath "
